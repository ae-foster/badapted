...
class Model:
    ...
    def update_beliefs(self, data):
        ...
        self.θ, _, ess = update_beliefs(self.p_log_pdf, self.θ, data, display=False, n_steps=2)
    ...
    def simulate_y(self, design_named_tuple, **kwargs):
        """
        ...
        p_chose_B = self.predictive_y(self.θ_true, design_df, **kwargs)
